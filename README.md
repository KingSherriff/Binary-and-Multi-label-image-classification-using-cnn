# A CNN-based tool for breast cancer histology image classification

**A deep learning tool for binary (benign/malignant) and multi-class (8 subtypes) classification of histopathology images.**

## Overview
This project develops a Convolutional Neural Network (CNN) system to assist in the pathological analysis of breast cancer tissue slides.
...
1.  **Clone this repository and install dependencies:**
    ```bash
    git clone https://github.com/KingSherriff/Binary-and-Multi-label-image-classification-using-cnn.git
    cd Binary-and-Multi-label-image-classification-using-cnn
